...
Route::middleware(['auth', 'verified'])
    ...
    ->group(function () {
        ...
        // ═══════════════════════════════════════════════════════════
        // ⭐ NEU: GEBÄUDE-LOG ROUTES
        // ═══════════════════════════════════════════════════════════
        Route::get('/{gebaeude}/logs', [GebaeudeLogController::class, 'index'])
            ->whereNumber('gebaeude')->name('logs.index');
        Route::post('/{gebaeude}/logs', [GebaeudeLogController::class, 'store'])
            ->whereNumber('gebaeude')->name('logs.store');
        Route::post('/{gebaeude}/logs/notiz', [GebaeudeLogController::class, 'notiz'])
            ->whereNumber('gebaeude')->name('logs.notiz');
        Route::post('/{gebaeude}/logs/telefonat', [GebaeudeLogController::class, 'telefonat'])
            ->whereNumber('gebaeude')->name('logs.telefonat');
        ...
        Route::post('/gebaeude/{gebaeude}/erstelle-adresse', [GebaeudeController::class, 'erstelleAdresse'])
...
Route::post('/gebaeude/logs/{log}/erledigt', [GebaeudeLogController::class, 'erledigt'])
    ->middleware(['auth', 'verified'])
    ->whereNumber('log')
    ->name('gebaeude.logs.erledigt');

// ⭐ NEU: Erinnerungs-Dashboard
Route::get('/gebaeude-erinnerungen', [GebaeudeLogController::class, 'erinnerungen'])
    ->middleware(['auth', 'verified'])
