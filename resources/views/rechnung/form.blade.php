...
document.addEventListener('DOMContentLoaded', function () {
  // Tab-Persistence (wie bei Gebäude)
  ...
  // Bei Submit Tab speichern
  const form = document.getElementById('rechnungForm');
  if (form) {
    form.addEventListener('submit', function () {
      const active = document.querySelector('#rechnungTabs .nav-link.active');
      if (active) localStorage.setItem('activeRechnungTab', active.dataset.bsTarget);
    });
  }
});
</script>
