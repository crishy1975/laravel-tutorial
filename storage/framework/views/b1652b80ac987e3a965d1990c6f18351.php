...
<div class="row g-3">
    ...
    <div class="d-flex flex-column flex-sm-row align-items-start align-items-sm-center justify-content-between gap-2">
      ...
      <div class="d-flex flex-wrap align-items-center gap-3">
        <div class="form-check form-switch m-0">
          <input class="form-check-input" type="checkbox" id="art-only-active" checked <?php echo e($hasId ? '' : 'disabled'); ?>>
          <label class="form-check-label small" for="art-only-active">Nur aktive</label>
        </div>
        <div class="text-muted small fw-semibold">
          Summe: <span id="art-summe-head" class="text-primary"><?php echo e(number_format($serverSumAktiv, 2, ',', '.')); ?></span> EUR
        </div>
      </div>
    </div>
    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasId && $aufschlagNaechstesJahr != 0): ?>
    <div class="alert alert-info py-2 px-3 mt-2 mb-0 small">
      <i class="bi bi-info-circle"></i>
      <strong>Aufschlag <?php echo e($naechstesJahr); ?>:</strong> 
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($aufschlagNaechstesJahr > 0): ?>
        <span class="text-success">+<?php echo e(number_format($aufschlagNaechstesJahr, 2, ',', '.')); ?>%</span>
      <?php else: ?>
        <span class="text-danger"><?php echo e(number_format($aufschlagNaechstesJahr, 2, ',', '.')); ?>%</span>
  ...
  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (! ($hasId)): ?>
    <div class="col-12">
          ...
          <div class="col-6">
            <div class="input-group input-group-sm">
              ...
              <input type="number" class="form-control text-end" id="new-einzelpreis-mobile" 
                     step="0.01" min="0" value="0.00" <?php echo e($hasId ? '' : 'disabled'); ?>>
            </div>
          </div>
          <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
              <div class="form-check form-switch m-0">
                <input class="form-check-input" type="checkbox" id="new-aktiv-mobile" <?php echo e($hasId ? 'checked' : 'disabled'); ?>>
                <label class="form-check-label small" for="new-aktiv-mobile">Aktiv</label>
              </div>
              <button type="button" id="btn-add-art-mobile" class="btn btn-sm btn-success" <?php echo e($hasId ? '' : 'disabled'); ?>>
  ...
  <div class="col-12 d-md-none" id="art-cards-mobile">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $artikelListe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php 
      ...
      ?>
      <div class="card mb-2 art-card-mobile <?php echo e($p->aktiv ? '' : 'opacity-50'); ?>" 
           data-id="<?php echo e($p->id); ?>" 
           data-aktiv="<?php echo e($p->aktiv ? '1' : '0'); ?>"
           data-basis-preis="<?php echo e($basisPreis); ?>"
           data-basis-jahr="<?php echo e($basisJahr); ?>">
        <div class="card-body p-2">
          <div class="d-flex justify-content-between align-items-start mb-2">
            <div class="flex-grow-1 me-2">
              <input type="text" class="form-control form-control-sm fw-semibold" 
                     data-field="beschreibung" value="<?php echo e($p->beschreibung); ?>">
            </div>
          ...
          <div class="row g-2">
            <div class="col-4">
              ...
              <input type="number" class="form-control form-control-sm text-end" 
                     data-field="anzahl" step="0.01" value="<?php echo e(number_format((float)$p->anzahl, 2, '.', '')); ?>">
            </div>
            <div class="col-4">
              <label class="form-label small text-muted mb-0">Preis</label>
              <input type="number" class="form-control form-control-sm text-end" 
                     data-field="einzelpreis" step="0.01" value="<?php echo e(number_format($anzeigePreis, 2, '.', '')); ?>">
            </div>
            <div class="col-4">
              ...
              <input type="text" class="form-control form-control-sm text-end bg-light" 
                     data-field="gesamtpreis" value="<?php echo e(number_format($rowTotal, 2, ',', '.')); ?>" disabled>
            </div>
          </div>
          <div class="d-flex justify-content-between align-items-center mt-2 pt-2 border-top">
            <div class="form-check form-switch m-0">
              <input class="form-check-input" type="checkbox" data-field="aktiv" <?php echo e($p->aktiv ? 'checked' : ''); ?>>
              <label class="form-check-label small">Aktiv</label>
            </div>
            <small class="text-muted">Basis: <?php echo e($basisJahr); ?></small>
          </div>
        </div>
      </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($artikelListe) == 0 && $hasId): ?>
      ...
      <table class="table table-hover align-middle mb-0" id="art-table">
        ...
        <tbody id="art-tbody">
          ...
          <tr id="art-new-row" class="table-secondary">
            ...
            <td class="text-center">
              <input class="form-check-input" type="checkbox" id="new-aktiv" <?php echo e($hasId ? 'checked' : 'disabled'); ?>>
            </td>
            <td class="text-end">
              <button type="button" id="btn-add-art" class="btn btn-sm btn-success" <?php echo e($hasId ? '' : 'disabled'); ?>>
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $artikelListe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr data-id="<?php echo e($p->id); ?>" 
                ...
                data-basis-jahr="<?php echo e($basisJahr); ?>"
                draggable="true"
                class="<?php echo e($p->aktiv ? '' : 'opacity-50'); ?>">
        ...
        <tfoot class="table-light">
          <tr class="fw-bold">
            ...
            <td class="text-end" id="art-summe-foot"><?php echo e(number_format($serverSumAktiv, 2, ',', '.')); ?> EUR</td>
            <td colspan="2"></td>
          </tr>
        </tfoot>
      </table>
...
<div id="art-root"
     ...
     data-route-store="<?php echo e(route('gebaeude.artikel.store', $gebaeude->id)); ?>"
     data-route-update0="<?php echo e(route('artikel.gebaeude.update', 0)); ?>"
     data-route-delete0="<?php echo e(route('artikel.gebaeude.destroy', 0)); ?>"
     data-route-reorder="<?php echo e(route('gebaeude.artikel.reorder', $gebaeude->id)); ?>"
     data-aktuelles-jahr="<?php echo e($aktuellesJahr); ?>">
</div>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH I:\Dokumente\entwicklung\laravel-tutorial\resources\views/gebaeude/partials/_artikel.blade.php ENDPATH**/ ?>