...
<div id="tour-hidden-inputs">
  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $zugeordnet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <input type="hidden" name="tour_ids[]" value="<?php echo e($tour->id); ?>">
...
<div class="row g-3">
    ...
    <div class="card border-primary mb-3">
      <div class="card-header bg-primary text-white py-2">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <span class="badge bg-white text-primary" id="zugeordnet-count-mobile"><?php echo e($zugeordnet->count()); ?></span>
        </div>
      </div>
      <div class="card-body p-2" id="zugeordnete-touren-mobile">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $zugeordnet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="tour-item-mobile d-flex align-items-center justify-content-between py-2 border-bottom" data-tour-id="<?php echo e($tour->id); ?>">
          <div class="d-flex align-items-center gap-2 flex-grow-1">
            <span class="badge bg-primary tour-position"><?php echo e($loop->iteration); ?></span>
            <div>
              <div class="fw-semibold small"><?php echo e($tour->name); ?></div>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tour->beschreibung): ?>
              <div class="text-muted small"><?php echo e(Str::limit($tour->beschreibung, 30)); ?></div>
              <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
          </div>
          <button type="button" class="btn btn-sm btn-outline-danger remove-tour-mobile ms-2" data-tour-id="<?php echo e($tour->id); ?>" data-tour-name="<?php echo e($tour->name); ?>" data-tour-beschreibung="<?php echo e(Str::limit($tour->beschreibung ?? '', 30)); ?>">
    ...
    <div class="card">
      <div class="card-header bg-light py-2">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <span class="badge bg-secondary" id="verfuegbar-count-mobile"><?php echo e($verfuegbar->count()); ?></span>
        </div>
      </div>
      <div class="card-body p-2" style="max-height: 300px; overflow-y: auto;" id="verfuegbare-touren-mobile">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $verfuegbar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="tour-item-mobile d-flex align-items-center justify-content-between py-2 border-bottom" data-tour-id="<?php echo e($tour->id); ?>">
          ...
          <button type="button" class="btn btn-sm btn-outline-primary add-tour-mobile ms-2" data-tour-id="<?php echo e($tour->id); ?>" data-tour-name="<?php echo e($tour->name); ?>" data-tour-beschreibung="<?php echo e(Str::limit($tour->beschreibung ?? '', 30)); ?>">
        ...
        <div class="card border-0 shadow-sm h-100">
          <div class="card-header bg-light">
            <h6 class="mb-0">
              ...
              <span class="badge bg-secondary ms-2" id="verfuegbar-count"><?php echo e($verfuegbar->count()); ?></span>
            </h6>
          </div>
          <div class="card-body p-2" style="max-height: 400px; overflow-y: auto;">
            <div id="verfuegbare-touren" class="tour-list">
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $verfuegbar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <div class="tour-card" data-tour-id="<?php echo e($tour->id); ?>" draggable="true">
                <div class="d-flex align-items-center gap-2">
                  <i class="bi bi-grip-vertical text-muted"></i>
                  <div class="flex-grow-1">
                    <div class="fw-semibold small"><?php echo e($tour->name); ?></div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tour->beschreibung): ?>
                    <div class="text-muted small"><?php echo e(Str::limit($tour->beschreibung, 40)); ?></div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                  </div>
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tour->aktiv): ?>
                  <span class="badge bg-success-subtle text-success border small">Aktiv</span>
                  <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                  <button type="button" class="btn btn-sm btn-outline-primary add-tour" data-tour-id="<?php echo e($tour->id); ?>">
        ...
        <div class="card border-primary shadow-sm h-100">
          <div class="card-header bg-primary text-white">
            <h6 class="mb-0">
              ...
              <span class="badge bg-white text-primary ms-2" id="zugeordnet-count"><?php echo e($zugeordnet->count()); ?></span>
            </h6>
          </div>
          <div class="card-body p-2" style="max-height: 400px; overflow-y: auto;">
            <div id="zugeordnete-touren" class="tour-list sortable">
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $zugeordnet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <div class="tour-card assigned" data-tour-id="<?php echo e($tour->id); ?>" draggable="true">
                <div class="d-flex align-items-center gap-2">
                  ...
                  <span class="badge bg-success-subtle text-success border small">Aktiv</span>
                  <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                  <button type="button" class="btn btn-sm btn-outline-danger remove-tour" data-tour-id="<?php echo e($tour->id); ?>">
                    <i class="bi bi-x-lg"></i>
                  </button>
                </div>
  ...
  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['tour_ids'];
...
<?php $__env->stopPush(); ?>
<?php /**PATH I:\Dokumente\entwicklung\laravel-tutorial\resources\views/gebaeude/partials/_touren.blade.php ENDPATH**/ ?>