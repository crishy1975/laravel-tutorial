...
<div class="row g-3">
  ...
  <div class="col-12">
    <div class="d-flex align-items-center gap-2">
      ...
      <span class="badge bg-secondary ms-auto"><?php echo e($entries->count()); ?></span>
    </div>
    <hr class="mt-2 mb-0">
  </div>
        ...
        <div class="row g-2">
          <div class="col-12 col-sm-4">
            ...
            <input type="date" class="form-control form-control-sm" id="tl_datum" name="datum"
              value="<?php echo e(old('datum', now()->toDateString())); ?>" <?php echo e($hasId ? '' : 'disabled'); ?>>
          </div>
          <div class="col-12 col-sm-5">
            <label class="form-label small mb-1 d-sm-none">Bemerkung2</label>
            <input type="text" class="form-control form-control-sm" id="tl_bem"
              placeholder="Bemerkung (optional)" <?php echo e($hasId ? '' : 'disabled'); ?>>
          </div>
          <div class="col-12 col-sm-3">
            <button type="button" id="tl_add_btn" class="btn btn-success btn-sm w-100" <?php echo e($hasId ? '' : 'disabled'); ?>>
  ...
  <div class="col-12 d-md-none" id="tl-cards-mobile">
    ...
    <div class="card mb-2 tl-card-mobile" data-id="<?php echo e($e->id); ?>">
      <div class="card-body p-2">
        <div class="d-flex justify-content-between align-items-start">
          <div>
            <div class="fw-semibold">
              <?php echo e(optional(\Illuminate\Support\Carbon::parse($e->datum))->format('d.m.Y')); ?>

            </div>
            <div class="text-muted small"><?php echo e($e->bemerkung ?: '-'); ?></div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($e->person_name): ?>
            <div class="text-muted small"><i class="bi bi-person"></i> <?php echo e($e->person_name); ?></div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          </div>
          <div class="d-flex flex-column align-items-end gap-1">
            <div class="form-check form-switch m-0">
              <input class="form-check-input tl-toggle-verrechnen" type="checkbox"
                data-id="<?php echo e($e->id); ?>" <?php if($e->verrechnen ?? false): echo 'checked'; endif; ?>>
              <label class="form-check-label small">Verr.</label>
            </div>
            <button type="button" class="btn btn-sm btn-outline-danger tl-del-btn" data-id="<?php echo e($e->id); ?>">
              <i class="bi bi-trash"></i>
            </button>
          </div>
        </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($e->verrechnet_mit_rn_nummer): ?>
        <div class="mt-1 pt-1 border-top">
          <small class="text-success"><i class="bi bi-check-circle"></i> RN: <?php echo e($e->verrechnet_mit_rn_nummer); ?></small>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      </div>
    </div>
  ...
  <div class="col-12 d-none d-md-block">
    <div class="table-responsive">
      <table class="table table-hover table-sm align-middle mb-0">
        ...
        <tbody id="tl_tbody">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr data-id="<?php echo e($e->id); ?>">
            <td class="text-nowrap"><?php echo e(optional(\Illuminate\Support\Carbon::parse($e->datum))->format('d.m.Y')); ?></td>
            <td><?php echo e($e->bemerkung ?: '-'); ?></td>
            <td><?php echo e($e->person_name ?: '-'); ?></td>
            <td>
              <div class="form-check form-switch m-0">
                <input class="form-check-input tl-toggle-verrechnen" type="checkbox"
                  data-id="<?php echo e($e->id); ?>" <?php if($e->verrechnen ?? false): echo 'checked'; endif; ?>>
            ...
            <td><?php echo e($e->verrechnet_mit_rn_nummer ?: '-'); ?></td>
            <td class="text-end">
              <button type="button" class="btn btn-sm btn-outline-danger tl-del-btn" data-id="<?php echo e($e->id); ?>">
                <i class="bi bi-trash"></i>
              </button>
...
<div id="timeline-root"
  ...
  data-route-store="<?php echo e($routeStore); ?>"
  data-route-destroy0="<?php echo e($routeDestroy0); ?>"
  data-route-toggle-base="<?php echo e(url('/timeline')); ?>"
  data-return-to="<?php echo e(url()->current()); ?>">
</div>
...
</script><?php /**PATH I:\Dokumente\entwicklung\laravel-tutorial\resources\views/gebaeude/partials/_timeline.blade.php ENDPATH**/ ?>