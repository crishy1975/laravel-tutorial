...
<div class="modal fade" id="modalNotiz" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
        <div class="modal-content">
            <form method="POST" action="<?php echo e(route('gebaeude.logs.notiz', $gebaeude->id)); ?>">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="modalTelefonat" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
        <div class="modal-content">
            <form method="POST" action="<?php echo e(route('gebaeude.logs.telefonat', $gebaeude->id)); ?>">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="modalProblem" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
        <div class="modal-content">
            <form method="POST" action="<?php echo e(route('gebaeude.logs.problem', $gebaeude->id)); ?>">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="modalErinnerung" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
        <div class="modal-content">
            <form method="POST" action="<?php echo e(route('gebaeude.logs.erinnerung', $gebaeude->id)); ?>">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="modalNeuerLog" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-fullscreen-sm-down">
        <div class="modal-content">
            <form method="POST" action="<?php echo e(route('gebaeude.logs.store', $gebaeude->id)); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH I:\Dokumente\entwicklung\laravel-tutorial\resources\views/gebaeude/partials/_log_modals.blade.php ENDPATH**/ ?>