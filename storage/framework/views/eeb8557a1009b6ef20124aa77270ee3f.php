...
<!-- DEBUG: Dokumente-Modals geladen für Gebäude #<?php echo e($gebaeude->id ?? 'NICHT GESETZT'); ?> -->
    ...
    <div class="modal fade" id="modalFotoAufnehmen" tabindex="-1">
        <div class="modal-dialog modal-fullscreen-sm-down">
            <div class="modal-content">
                <form method="POST" 
                      action="<?php echo e(route('gebaeude.dokumente.store', $gebaeude->id)); ?>" 
                    ...
                    <div class="modal-body">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="file" class="d-none upload-datei-input" id="uploadDateiDatei"
                                           accept=".<?php echo e(implode(',.', $erlaubteEndungen)); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-none d-sm-block mb-4">
                            ...
                            <input type="file" 
                                   ...
                                   accept=".<?php echo e(implode(',.', $erlaubteEndungen)); ?>">
                            <div class="form-text">
                                Erlaubt: PDF, DOC(X), XLS(X), Bilder, TXT (max. <?php echo e($maxSize); ?> MB)
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <select class="form-select" id="uploadKategorie" name="kategorie">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $kategorien; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH I:\Dokumente\entwicklung\laravel-tutorial\resources\views/gebaeude-dokumente/_dokumente_modals.blade.php ENDPATH**/ ?>